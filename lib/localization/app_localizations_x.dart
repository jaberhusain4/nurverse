...
extension AppLocalizationsX on AppLocalizations {
  ...
  String get nextPrayerPrefix => tr('পরবর্তী', 'Next');
  ...
  String naflDescription(String key) {
    switch (key) {
      case 'ishraq':
        return tr('সূর্যোদয়ের কিছুক্ষণ পর', 'Shortly after sunrise');
      case 'duha':
        return tr('সকাল থেকে দুপুরের পূর্ব পর্যন্ত', 'From morning until before noon');
      case 'awwalabin':
        return tr('মাগরিবের পর', 'After Maghrib');
      case 'tahajjud':
        return tr('রাতের শেষাংশ', 'The latter part of the night');
      default:
        return key;
    }
  }
