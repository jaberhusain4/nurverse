...
import '../../widgets/dua/dua_audio_button.dart';
    ...
    return Scaffold(
      ...
      body: ListView.separated(
        ...
        itemBuilder: (context, index) =>
            _buildDuaCard(context, widget.category.items[index], l10n, primary),
      ),
    );
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            translation,
            style: theme.textTheme.bodyMedium?.copyWith(fontSize: 14, height: 1.65),
          ),
