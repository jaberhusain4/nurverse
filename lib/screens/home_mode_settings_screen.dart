            ...
            children: [
              Text(
                l10n.localeText(values: {
                  'bn': 'আপনার পছন্দের হোম স্ক্রিনের ধরন নির্বাচন করুন।',
                  'en': 'Choose the Home layout you prefer.',
                  'ar': 'اختر نوع شاشة المنزل الذي تفضله.',
                }),
              ...
              _ModeCard(
                ...
                subtitle: l10n.localeText(values: {
                  'bn': 'আরও তথ্য, সালাতের তথ্য ও দৈনিক কনটেন্টসহ বিস্তারিত হোম।',
                  'en': 'More details, prayer information and daily content.',
                  'ar': 'تفاصيل أكثر ومعلومات الصلاة والمحتوى اليومي.',
                }),
              ...
              _ModeCard(
                ...
                subtitle: l10n.localeText(values: {
                  'bn': 'পরিষ্কার, শান্ত এবং প্রতিদিনের প্রয়োজনীয় বিষয়গুলোকে গুরুত্ব দেয়।',
                  'en': 'Clean, calm and focused on everyday essentials.',
                  'ar': 'تصميم هادئ ونظيف يركز على الأساسيات اليومية.',
                }),
                badge: l10n.localeText(values: {
                  'bn': 'সহজ',
                  'en': 'Clean',
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        l10n.localeText(values: {
                          'bn': 'আপনি যেকোনো সময় এই পছন্দ পরিবর্তন করতে পারবেন। আপনার সালাতের তথ্য ও কুরআনের অগ্রগতি অপরিবর্তিত থাকবে।',
                          'en': 'You can change this choice anytime. Your prayer data and Quran progress stay unchanged.',
                          'ar': 'يمكنك تغيير هذا الاختيار في أي وقت. ستبقى بيانات الصلاة وتقدم القرآن دون تغيير.',
                        }),
                        style: Theme.of(context).textTheme.bodySmall?.copyWith(
                          fontSize: 11.5,
                          color: context.secondaryTextColor,
