...
class HafeziPageScreen extends StatefulWidget {
  /// Physical PDF page (1..610).
  final int? initialPdfPage;

  /// Backward-compatible alias. Also means physical PDF page.
...
class _HafeziPageScreenState extends State<HafeziPageScreen> {
  ...
  // Hafezi controls intentionally remain visible.
  ...
  Future<void> _initialize() async {
    try {
      ...
      // IMPORTANT:
      // Explicitly supplied page always wins over Last Read.
                ...
                Expanded(
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final current = _service.locationForPdfPage(
                        _currentPdfPage,
                      );
                      ...
                      return Material(
                        ...
                        child: InkWell(
                          ...
                          onTap: () {
                            ...
                            // Always open START of selected Para.
                            // Last Read is never used here.
  ...
  // Hafezi Quran controls are intentionally always visible.
  // No auto-hide timer is used.
  ...
  void _toggleControls() {
    // Keep the existing top-area tap harmless.
        ...
        children: [
          Positioned.fill(
            child: PdfView(
              ...
              // page 1 on RIGHT, page 2 on LEFT.
              reverse: true,
          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    'পারা ${location.juzNumber} • '
                    'পৃষ্ঠা ${location.pageInJuz}/'
                    '${location.juzPageCount}',
                    style: const TextStyle(
                      color: Colors.white,
                      fontSize: 14,
                      fontWeight: FontWeight.w800,
          ...
          children: [
            Expanded(
              child: _BottomAction(
                ...
                label: 'পরের পৃষ্ঠা',
                enabled: _currentPdfPage < _pageCount,
                onTap: _nextPage,
              ),
            ),
            Expanded(
