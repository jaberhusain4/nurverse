...
class SettingsScreen extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _buildJamaatCard(context, settings),
  ...
  Widget _buildJamaatCard(BuildContext context, SettingsProvider settings) {
    return Container(
  ...
  Future<bool> _saveJamaatTime(
    ...
    final String normalized = '$hour:${minute.toString().padLeft(2, '0')}';
          ...
          content: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<int>(
                ...
                onChanged: (value) {
                  if (value != null) {
                    settings.setHijriAdjustment(value);
                  }
                },
              ),
            ],
        ...
        return _buildBottomSheet(
          ...
          children: [
            _buildChoiceTile(
              ...
              selected: settings.quranTranslation == 'Bangla',
              onTap: () async {
    ...
    return Material(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color:
                selected ? primary.withValues(alpha: .07) : Colors.transparent,
            borderRadius: BorderRadius.circular(17),
            border: Border.all(
              color:
                  selected
