...
class SimpleHomeScreenV4 extends StatefulWidget {
  const SimpleHomeScreenV4({super.key, this.onNavigateTab});

  final Function(int)? onNavigateTab;

  @override
  State<SimpleHomeScreenV4> createState() => _SimpleHomeScreenV4State();
}

class _SimpleHomeScreenV4State extends State<SimpleHomeScreenV4> {
  Timer? _timer;
...
class _Hero extends StatelessWidget {
  ...
  final String clock, nextPrayer, nextPrayerTime, remaining, currentPrayer;
  final String sunrise, sunset, languageCode;
  ...
  Widget build(BuildContext context) {
    ...
    final clockStyle = GoogleFonts.googleSans(
      fontSize: 15,
        ...
        children: [
          ...
          Positioned(
            ...
            child: CustomPaint(
              ...
              painter: _LandscapePainter(dark: isNight),
            ),
          ),
          Padding(
...
class _Footer extends StatelessWidget {
  const _Footer({
    required this.date,
    required this.activeProhibited,
    required this.countdown,
    required this.languageCode,
  });

  final String date, countdown, languageCode;
      ...
      child: Row(
        children: [
          ...
          Row(
            children: [
              Icon(
                activeProhibited ? Icons.block_rounded : Icons.schedule_rounded,
                size: 18,
                color: primary,
              ),
