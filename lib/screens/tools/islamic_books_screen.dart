...
class _IslamicBooksScreenState extends State<IslamicBooksScreen> {
  static const _readBooks = <_BookResource>[
    ...
    _BookResource(
      ...
      description: 'মোহাম্মদ আকরম খাঁর বাংলা অনুবাদগ্রন্থের প্রথম খণ্ড।',
      source: 'Wikimedia Commons • Bengali PDF',
    ...
    _BookResource(
      ...
      description: 'বাংলা ইসলামিক পাঠ্যবই — সরাসরি reader-এ পড়া যাবে।',
      source: 'Wikimedia Commons • CC BY 4.0',
    ...
    _BookResource(
      title: 'এক নজরে ইসলাম',
      description: 'বাংলা ইসলাম বিষয়ক গ্রন্থ — সরাসরি reader-এ পড়া যাবে।',
  ...
  static const _downloadBooks = <_BookResource>[
    _BookResource(
      title: 'মিশকাতুল মাসাবীহ — বাংলা অনুবাদসহ',
      description: 'কওমি ধারায় বহুল পঠিত হাদিসগ্রন্থ। অনলাইন উৎসে Download option রয়েছে।',
      source: 'তাওহীদের ডাক • PDF download source',
      icon: Icons.download_for_offline_rounded,
      url: 'https://www.tauhiderdak.com/mishkatul-masabih-bangla',
      isPdf: false,
      isDownloadPage: true,
    ),
  ];
  ...
  Future<void> _openBook(_BookResource book) async {
    ...
    if (book.isDownloadPage) {
      _showMessage(
        'এই বইটি সরাসরি reader-এ খোলা যায় না। Download source থেকে PDF সংগ্রহ করুন।',
      );
      return;
    }
  ...
  Future<void> _downloadBook(_BookResource book) async {
    ...
    if (book.isDownloadPage) {
      _showMessage(
        'মিশকাতুল মাসাবীহ-এর Download source-এ একাধিক PDF খণ্ড রয়েছে। আপাতত source page থেকে প্রয়োজনীয় PDF নির্বাচন করুন।',
      );
      return;
    }
    ...
    try {
      ...
      final booksDirectory = Directory(
        p.join(baseDirectory.path, 'NurVerse', 'Islamic Books'),
      );
      ...
      _showMessage(
        '“${book.title}” Download complete — NurVerse/Islamic Books-এ সংরক্ষিত হয়েছে।',
      );
    } catch (_) {
      if (!mounted) return;
  ...
  Future<void> _deleteBook(_BookResource book) async {
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          '“${book.title}” NurVerse-এর download storage থেকে মুছে যাবে।',
        ),
        actions: [
          TextButton(
      ...
      body: ListView(
        ...
        children: [
          ...
          const _SectionHeader(
            ...
            subtitle: 'যেসব বই সরাসরি পড়ার বদলে Download source থেকে সংগ্রহ করতে হয়',
      ...
      builder: (context) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'NurVerse আপাতত বাংলা ভাষার নির্বাচিত ইসলামিক বই রাখছে। সরাসরি পড়ার বইগুলো PDF reader-এ খোলা হয়। Download E-Book অংশে রাখা বইগুলো তাদের Download source অনুযায়ী সংগ্রহ করা হবে এবং ভবিষ্যতে direct file integration যুক্ত করা যাবে।',
              style: TextStyle(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            Expanded(
              child: Text(
                'নির্বাচিত বাংলা ইসলামিক বই — অনলাইনে পড়ুন অথবা Download source থেকে বই সংগ্রহ করে offline-এ সংরক্ষণ করুন।',
                style: TextStyle(
                  color: context.secondaryTextColor,
                  fontSize: 13,
                  height: 1.5,
