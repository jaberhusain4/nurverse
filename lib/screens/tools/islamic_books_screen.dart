...
class _BooksIntroCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Card(child: Padding(padding: const EdgeInsets.all(18), child: Row(children: [
      ...
      Expanded(child: Text('নির্বাচিত বাংলা ইসলামিক বই — অনলাইনে পড়ুন অথবা অনুমোদিত বই offline-এ সংরক্ষণ করুন।', style: TextStyle(color: context.secondaryTextColor, fontSize: 13, height: 1.5))),
    ])));
  }
}
...
class _SectionHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Icon(icon, size: 20, color: AppColors.seaBlue), const SizedBox(width: 9),
...
class _BookCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return Card(child: InkWell(borderRadius: BorderRadius.circular(20), onTap: onTap, child: Padding(padding: const EdgeInsets.fromLTRB(15, 15, 12, 13), child: Row(children: [
      ...
      Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        if (onDownload != null) IconButton(tooltip: downloaded ? 'মুছে ফেলুন' : actionLabel, onPressed: progress != null ? null : onDownload, icon: Icon(downloaded ? Icons.delete_outline_rounded : Icons.download_rounded)),
      ]),
    ])));
  }
}
