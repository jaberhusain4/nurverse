class HadithBengaliTitleBuilder {
  ...
  static String build(String english) {
    ...
    for (final raw in words) {
      ...
      if (value != null) {
        ...
        translated.add(_transliterate(word));
      }
    }

    var result = translated.join(' ').trim();
    result = result
  ...
  static const Map<String, String> _exact = {
    ...
    'virtues and merits of the prophet pbuh and his companions': 'নবী (সা.) ও তাঁর সাহাবীদের ফযীলত ও মর্যাদা',
    'prophetic commentary on the quran tafseer of the prophet pbuh': 'কুরআন বিষয়ে নবী (সা.)-এর তাফসীর',
  ...
  static const Map<String, String> _words = {
    ...
    'coercion': 'জবরদস্তি',
    'tricks': 'কৌশল',
    'afflictions': 'বিপদ-আপদ',
    'end': 'শেষ',
    'world': 'দুনিয়া',
    'wishes': 'আকাঙ্ক্ষা',
    'oneness': 'একত্ব',
    'uniqueness': 'অদ্বিতীয়তা',
    'tawheed': 'তাওহীদ',
    'book': 'কিতাব',
    'chapter': 'অধ্যায়',
    'knowledge': 'জ্ঞান',
  ...
  static String _transliterate(String word) {
    ...
    for (final ch in result.split('')) {
      if (consonants.containsKey(ch)) {
        buffer.write(consonants[ch]);
      } else if (vowels.containsKey(ch)) {
        buffer.write(vowels[ch]);
    ...
    final value = buffer.toString().replaceAll(RegExp(r'া{2,}'), 'া');
    return value.isEmpty ? 'বিষয়' : value;
  }
}
