    ...
    return AppCard(
      child: Column(
        ...
        children: [
          ...
          Row(children: [
            _sunItem(context, icon: Icons.wb_sunny_outlined, title: l10n.sunrise, value: sunInfo.sunriseString),
            Container(width: 1, height: 30, color: AppColors.seaBlue.withValues(alpha: .08)),
            _sunItem(context, icon: Icons.nightlight_round, title: l10n.sunset, value: sunInfo.sunsetString),
          ]),
        ],
      ),
    );
