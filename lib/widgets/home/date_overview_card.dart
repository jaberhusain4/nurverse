    ...
    return Expanded(
      child: Column(
        children: [
          ...
          Text(value, textAlign: TextAlign.center, maxLines: 2, overflow: TextOverflow.ellipsis, style: theme.textTheme.bodySmall?.copyWith(fontSize: 13, fontWeight: FontWeight.bold, color: context.primaryTextColor)),
        ],
      ),
    );
  }
        ...
        children: [
          ...
          Flexible(
            child: Column(
              ...
              children: [
                Text(title, maxLines: 1, overflow: TextOverflow.ellipsis, style: theme.textTheme.bodySmall?.copyWith(fontSize: 13, color: context.secondaryTextColor, fontWeight: FontWeight.w600)),
                const SizedBox(height: 2),
                Text(value, maxLines: 1, overflow: TextOverflow.ellipsis, style: theme.textTheme.bodyMedium?.copyWith(fontWeight: FontWeight.bold, fontSize: 13, color: context.primaryTextColor)),
              ],
            ),
          ),
        ],
    ...
    return AppCard(
      child: Column(
        ...
        children: [
          Row(
            children: [
              Container(width: 34, height: 34, decoration: BoxDecoration(color: AppColors.seaBlue.withValues(alpha: .10), borderRadius: BorderRadius.circular(10)), child: const Icon(Icons.calendar_month_rounded, size: 18, color: AppColors.seaBlue)),
              const SizedBox(width: 10),
              Expanded(child: Text(l10n.tr('আজকের তারিখ', 'Today'), style: Theme.of(context).textTheme.titleSmall?.copyWith(fontWeight: FontWeight.bold, fontSize: 16))),
            ],
          ),
          const SizedBox(height: 16),
          Row(children: [
            _dateItem(context, icon: Icons.calendar_today_rounded, label: l10n.tr('বাংলা', 'Bangla'), value: _banglaDate(englishDate)),
            _divider(context),
          ...
          Row(children: [
            _sunItem(context, icon: Icons.wb_sunny_outlined, title: l10n.tr('সূর্যোদয়', 'Sunrise'), value: sunInfo.sunriseString),
            Container(width: 1, height: 30, color: AppColors.seaBlue.withValues(alpha: .08)),
            _sunItem(context, icon: Icons.nightlight_round, title: l10n.tr('সূর্যাস্ত', 'Sunset'), value: sunInfo.sunsetString),
          ]),
        ],
      ),
    );
