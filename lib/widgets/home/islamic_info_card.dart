...
class IslamicInfoCard extends StatelessWidget {
  ...
  String _normalizeLocation(String value) {
    ...
    if (lower == 'লোকেশন লোড হচ্ছে...' ||
        lower == 'loading location...' ||
        lower == 'جارٍ تحميل الموقع...') {
      return _loadingLocation();
    }

    if (lower.contains('mirpur')) {
      return 'Mirpur, Dhaka, Bangladesh';
    }
    ...
    if (lower.contains('uttara')) {
      return 'Uttara, Dhaka, Bangladesh';
    }

    if (lower.contains('dhaka') && !lower.contains('bangladesh')) {
      return '$raw, Bangladesh';
    }
  ...
  Widget _locationHeader(
    ...
    required double locationLabelSize,
  }) {
    final label = Text(
      _label(
        bn: 'বর্তমান অবস্থান',
