...
class IslamicInfoCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final locationIconSize = compactLocation ? 18.0 : 18.0;
    ...
    final locationHeader = compactLocation
        ? Row(
            children: [
              Text(
                _label(bn: 'বর্তমান অবস্থান', en: 'Current location', ar: 'الموقع الحالي'),
                maxLines: 1,
                softWrap: false,
                overflow: TextOverflow.clip,
                style: TextStyle(color: secondary, fontSize: locationLabelSize, fontWeight: FontWeight.w600, height: 1.0),
              ),
                ...
                child: SizedBox(
                  ...
                  child: FittedBox(
                    ...
                    child: Text(
                      ...
                      maxLines: 1,
                      softWrap: false,
                      style: TextStyle(color: text, fontSize: locationFontSize, fontWeight: FontWeight.w700, height: 1.0),
                    ),
                  ),
                ),
              ),
    ...
    return Container(
      ...
      decoration: BoxDecoration(color: context.cardColor, borderRadius: BorderRadius.circular(20), border: Border.all(color: primary.withValues(alpha: .055))),
...
class _DateBlock extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(constraints: const BoxConstraints(minHeight: 54), padding: const EdgeInsets.symmetric(horizontal: 7, vertical: 7), decoration: BoxDecoration(color: primary.withValues(alpha: .035), borderRadius: BorderRadius.circular(13)), child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
    Text(label, maxLines: 1, overflow: TextOverflow.ellipsis, textAlign: TextAlign.center, style: TextStyle(color: secondary, fontSize: 12, fontWeight: FontWeight.w600)),
...
class _SunBlock extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(constraints: const BoxConstraints(minHeight: 64), decoration: BoxDecoration(color: primary.withValues(alpha: .045), borderRadius: BorderRadius.circular(14)), child: Stack(alignment: Alignment.center, children: [
    Positioned(left: 14, child: Icon(icon, size: 20, color: primary)),
